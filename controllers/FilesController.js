...
class FilesController {
  ...
  // Handle fetching a specific file's metadata
  ...
  // Handle fetching a list of files with pagination
  ...
  // Handle retrieving the content of a file
  static async getFile(request, response) {
    const idFile = request.params.id || '';
    const size = parseInt(request.query.size, 10) || 0;
